...
public class SendChat extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CircleInfo searchCircleInfo = (CircleInfo)session.getAttribute("searchCircleInfo");
		...
		UserInfo toUserInfo = userInfoDAO.getUserInfoByCircleID(searchCircleInfo.getCircleID());
